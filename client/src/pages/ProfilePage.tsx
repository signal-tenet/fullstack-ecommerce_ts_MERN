...
import { Box, Button, FormControl, Heading, Stack, Text, AlertIcon, AlertTitle, AlertDescription, Alert, Flex, Card, CardHeader, CardBody, StackDivider, useToast } from '@chakra-ui/react';
...
const ProfilePage: React.FC = () => {
    ...
    return userInfo ? (
        <Formik
            ...
            onSubmit={(values: ProfileFormValues, formikHelpers: FormikHelpers<ProfileFormValues>) => {
                dispatch(
                    updateProfile(
                        userInfo._id,
                        values.name,
                    ...
                    >
                        <Stack flex='1.5' mb={{ base: '2xl', md: 'none' }}>
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                <Stack spacing='6' as={FormControl}>
                                    {error && (
                                        <Alert
                                            status='error'
